...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #123 has been placed by John Doe.create': {
    roles: ['business-owner', 'team-member'],
    key: 'order_created',
    tenantPath: [],
    userPath: [],
  },
  'Payment of $100 has been received from John Doe.create': {
    roles: ['business-owner', 'team-member'],
    key: 'payment_received',
    tenantPath: [],
    userPath: [],
  },
  'Team Member Jane Doe has updated the inventory.update': {
    roles: ['business-owner', 'team-member'],
