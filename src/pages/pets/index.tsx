...
export function PetListPage(props: PetListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPets({
        relations: ['user', 'purchase.count', 'sale.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('purchase', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('sale', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'sale',
          header: 'Sale',
          accessorKey: 'sale',
          cell: ({ row: { original: record } }: any) => record?._count?.sale,
        }
      : null,
