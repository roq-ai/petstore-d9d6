  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Petstore: Streamlining Your Pet Management Needs. Buy, Sell, and Manage Pets with Ease and Efficiency."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1450778869180-41d0601e046e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwZXRzfGVufDB8fHx8MTY5NTYyODI3MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@krista?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Krista Mangulsone`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Petstore: Streamlining Your Pet Management Needs. Buy, Sell, and Manage Pets with Ease and Efficiency.`}
            </Text>
            <Box
